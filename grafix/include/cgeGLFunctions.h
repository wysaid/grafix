...
namespace CGE
{
	...
	{
	public:
        SharedTexture() : m_textureID(0), m_refCount(NULL) {}
	...
	public:
		...
		inline void bindTexture2D(SharedTexture& texture, GLenum attachment = GL_COLOR_ATTACHMENT0)
		{
			bindTexture2D(texture.id(), texture.width, texture.height, attachment);
		}

		inline void bindTexture2D(SharedTexture& texture, GLsizei x, GLsizei y, GLsizei w, GLsizei h, GLenum attachment = GL_COLOR_ATTACHMENT0)
		{
			bindTexture2D(texture.id(), x, y, w, h, attachment);
		}
	...
	enum CGEGlobalBlendMode { CGEGLOBAL_BLEND_NONE, CGEGLOBAL_BLEND_ALPHA, CGEGLOBAL_BLEND_ALPHA_SEPERATE, CGEGLOBAL_BLEND_ADD, CGEGLOBAL_BLEND_MULTIPLY, CGEGLOBAL_BLEND_MULTIPLY_SEPERATE };

	inline void cgeSetGlobalBlendMode(CGEGlobalBlendMode mode)
	{
