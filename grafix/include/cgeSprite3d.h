...
namespace CGE
{
	...
	{
		SpriteArrayBufferComponent() : bufferData(NULL), bufferID(0), componentSize(0), bufferBytes(0), elementCnt(0), bufferKind(GL_FALSE), bufferUsage(GL_FALSE), bufferDataKind(GL_FALSE), bufferStride(0) {}
		...
		SpriteArrayBufferComponent(GLuint bufID, int compSize, int bytes, GLenum bufKind, GLenum bufUsage, GLenum dataKind, GLsizei elemCnt = 0, GLsizei stride = 0) : bufferData(NULL), bufferID(0), componentSize(compSize), bufferBytes(bytes), elementCnt(elemCnt), bufferKind(bufKind), bufferUsage(bufUsage), bufferDataKind(dataKind), bufferStride(stride) {}
