...
namespace CGE
{
	...
	protected:
		virtual bool initImageFBO(const void* data, int w, int h, GLenum channelFmt, GLenum dataFmt);
	...
	{
	public:
		CGEVideoHandler() : m_obj(NULL), m_initDrawFunc(NULL) {}
		...
		void drawResultToScreen(GLint x, GLint y, GLint w, GLint h);
		void clearCache() { CGE_DELETE(m_obj); }
