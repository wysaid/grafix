...
namespace CGE
{
	...
	{
	public:
        TimeActionInterfaceAbstract() : m_repeatTimes(1), m_startTime(0), m_endTime(0), m_duringTime(0) {}
        TimeActionInterfaceAbstract(float startTime, float endTime, float repeatTimes = 1) : m_repeatTimes(repeatTimes), m_startTime(startTime), m_endTime(endTime), m_duringTime(endTime - startTime) {}
	...
	{
	public:
		TimeActionInterface() : TimeActionInterfaceAbstract(), m_bindObj(NULL) {}
		TimeActionInterface(float startTime, float endTime, float repeatTimes = 1) : TimeActionInterfaceAbstract(startTime, endTime, repeatTimes), m_bindObj(NULL) {}
