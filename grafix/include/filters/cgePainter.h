...
//		static GLfloat getMaxPointSize() { GLfloat n; glGetFloatv(GL_POINT_SIZE_MAX, &n); return n; }
		...
		CGETextureBlendMode getBlendMode() { return m_blendMode; }
		virtual void setBlendMode(CGETextureBlendMode mode) { m_blendMode = mode; }

		GLfloat getOpacity() { return m_opacity; }
	...
	protected:
		static const char* const paramPositionIndexName;
		static const char* const paramDraw2ScreenTextureName;
		static const char* const paramPointSizeName;
		static const char* const paramColorOpacityName;
		static const char* const paramRotationRadName;
		static const char* const paramRotationNormalName;
		static const char* const paramBrushTextureName;
		static const char* const paramModelViewProjectionName;
		static const char* const paramBlendIntensityName;
		static const char* const paramInputImageName;
		static const char* const paramBlendTextureName;
	...
	protected:
		...
		static ParamType paramSamplerStepsName;
