...
namespace CGE
{
	...
	protected:
		...
		static ParamType paramSamplerStepName;
		//The length of blurNorm must be 1.
		static ParamType paramBlurNormalName;
	...
	public:
		...
		void render2Texture(CGEImageHandlerInterface* handler, GLuint dstTexture, const GLfloat* posVertices);
	...
	protected:
		static ParamType paramIntensity;
		static ParamType paramBlurredTexName;
