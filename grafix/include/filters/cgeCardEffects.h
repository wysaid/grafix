...
namespace CGE
{
	...
	protected:
		...
		static ParamType paramOriginAspectRatioName;
		static ParamType paramZoneStartName;
		static ParamType paramZoneRangeName;
		static ParamType paramZoneEndName;
		static ParamType paramAlignName;
	};
