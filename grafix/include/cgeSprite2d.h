...
// 		//模板兼容接口, 不应该被调用
// 		SpriteInterface2d(SharedTexture& texture) { assert(0); }
//		virtual ~SpriteInterface2d();
	...
	protected:
		...
		Sprite2d(SharedTexture& texture, bool bInitProgram);
	...
	public:
		...
		Sprite2d(SharedTexture& texture);
		virtual ~Sprite2d();
	...
	public:
        ...
        Sprite2dExt(SharedTexture& texture);
		~Sprite2dExt();
...
//		virtual void render();
	...
	public:
		...
		Sprite2dWithAlphaGradient(SharedTexture& texture);
	...
	public:
		...
		Sprite2dInterChange(SharedTexture& texture);
		~Sprite2dInterChange();
...
//		virtual void _drawFunc();
	...
	public:
		Sprite2dInterChangeExt(GLuint textureID, int width, int height) : Sprite2dInterChange(textureID, width, height), m_frameIndex(0), m_deltaTime(0.0f), m_deltaAccum(100.0f), m_lastTime(0.0f) {}
		Sprite2dInterChangeExt(SharedTexture& texture) : Sprite2dInterChange(texture), m_frameIndex(0), m_deltaTime(0.0f), m_deltaAccum(100.0f), m_lastTime(0.0f) {}
	...
	public:
		...
		Sprite2dWith3dSpace(SharedTexture& texture);
		~Sprite2dWith3dSpace();
